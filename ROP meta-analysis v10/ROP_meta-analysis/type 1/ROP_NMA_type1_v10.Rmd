...
Hence, overall, taking all treatments into account, a predicted 84% (80%-88%) of patients with type 1 ROP would likely require no retreatment.
...
* Eylea effect size (predicted proportion):  76.9%  [60.0 - 90.4] ..... (n=`r samples_Eylea`)
* Laser effect size (predicted proportion):  88.8%  [83.2 - 93.5] ..... (n=`r samples_Laser`)
...
Again I have looked into the power associated with these studies. Below is a sunset power-enhanced funnel plot which uses the standard error and effect sizes to calculate the power for all studies. Used the lower bound of the summary effect size from the forest plot above (0.80).
...
```{r}
### Create sunset power-enhanced funnel plot
