...
UPDATE (30/03/22) - we seem to have an even smaller band of statistical significance.  Between 25.8 and 26.7 weeks GA, Laser is associated with a statistically significant reduction in risk of requiring retreatment when compared to Lucentis. 
...
UPDATE (30/03/22) - Again we now have no statististical differences here at any gestational age 
...
UPDATE (30/03/22) - Between 25.8 and 26.7 weeks GA, Laser is associated with a statistically significant reduction in risk of requiring retreatment when compared to Lucentis. No moderating effect of g.age found on any other treatment modality comparison.
...
df_long2_bw <- df_long2_bw[!(row.names(df_long2_bw) %in% c(30)) , ]
...
UPDATE (30/03/22) - we now a smaller band of statistical significance than before. We have a significant moderating effect where birth weights between 846g and 932g are associated with significant reduction in risk of requiring retreatment if treated with Laser vs Lucentis
